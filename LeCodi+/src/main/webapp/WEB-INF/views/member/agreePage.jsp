...
<body>
	...
	<form method="post" action="joinForm" onsubmit="return CheckForm(this)" name="agreeform">
		<h1>Le Codi</h1>
		<div class="tabs"></div>
		<br> <input type="checkbox"> <label
			id="termsServiceLb" for="termsService"> 르코디 이용약관 동의<span
			class="terms_choice">(필수)</span></label>
		<div class="terms_box">
			<div class="article">
				<h3 class="article__title">제 1 조 (목적)</h3>
				<p class="article__text">이 약관은 Le Codi(이하 르코디) 주식회사 ("회사" 또는
					"르코디")가 제공하는 르코디 및 르코디 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타
			...
			<div class="article">
				...
				<ol class="sections">
					<li class="sections__section">①"서비스"라 함은 구현되는 단말기(PC, TV,
						휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 르코디 및 르코디 관련 제반 서비스를
						의미합니다.</li>
		...
		<div>
			<br>
			<br>
			<input class="submit" type="submit" value="AGREE"onclick="checkForm()"> 
				<a href="javascript:history.back()"><input class="cancel" type="button"
				value="CANCEL"></a>
